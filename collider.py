...
wall_left = Entity(model='cube', collider='box', scale_y=2, scale_z=8, origin_y=-.5, color=color.azure, x=-4)
wall_right = duplicate(wall_left, x=4)
wall_back = Entity(model='cube', collider='box', scale_y=2, scale_x=8, origin_y=-.5, color=color.azure, z=4)
camera.y = 2
